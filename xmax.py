...
class XmaxSimple(object):
    ...
    QGSJetII04 = {'X0':    790.1,  # +- 0.3  # g cm**-2
                  'D':     54.2,   # +- 0.2  # g cm**-2
                  'xi':    -0.42,  # +- 0.12 # g cm**-2
    ...
    def get_sigma2_Xmax(self, mean_lnA, sigma2_lnA, E):
        ...
        sigma2_proton = m.p0 + m.p1 * np.log10(E / m.E0) + m.p2 * np.log10(E / m.E0)**2
